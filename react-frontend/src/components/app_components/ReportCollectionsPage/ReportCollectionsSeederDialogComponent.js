...
import seederData from "./reportCollections.seeder.json";
...
const ReportCollectionsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ReportCollectionsSeederDialogComponent);
