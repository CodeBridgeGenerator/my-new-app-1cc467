...
import SingleReportCollectionsPage from "../components/app_components/ReportCollectionsPage/SingleReportCollectionsPage";
import ReportCollectionProjectLayoutPage from "../components/app_components/ReportCollectionsPage/ReportCollectionProjectLayoutPage";
import SinglePentestReportsPage from "../components/app_components/PentestReportsPage/SinglePentestReportsPage";
import PentestReportProjectLayoutPage from "../components/app_components/PentestReportsPage/PentestReportProjectLayoutPage";
//  ~cb-add-import~
    ...
    return (
        <Routes>
            ...
            <Route path="/project" exact element={<DashboardAdminControl />} />
                ...
                // myapp
<Route path="/reportCollections/:singleReportCollectionsId" exact element={<SingleReportCollectionsPage />} />
<Route path="/reportCollections" exact element={<ReportCollectionProjectLayoutPage />} />
<Route path="/pentestReports/:singlePentestReportsId" exact element={<SinglePentestReportsPage />} />
<Route path="/pentestReports" exact element={<PentestReportProjectLayoutPage />} />
