...
const reportCollections = require("./reportCollections/reportCollections.service.js");
const pentestReports = require("./pentestReports/pentestReports.service.js");
...
module.exports = function (app) {
  ...
  app.configure(reportCollections);
  app.configure(pentestReports);
